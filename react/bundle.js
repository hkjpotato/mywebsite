...
/***/ function(module, exports, __webpack_require__) {
	...
	var Demo = _react2.default.createClass({
	  ...
	  getInitialState: function getInitialState() {
	    return {
	      ...
	      isPressed: false,
	      lastPressed: 0,
	      order: (0, _lodash2.default)(itemsCount)
	    };
	  },
	  ...
	  render: function render() {
	    ...
	    return _react2.default.createElement(
	      'div',
	      { className: 'demo8' },
	      (0, _lodash2.default)(itemsCount).map(function (i) {
	        var style = lastPressed === i && isPressed ? {
	          ...
	          y: (0, _reactMotion.spring)(order.indexOf(i) * 80, springConfig)
	        };
	        return _react2.default.createElement(
	          _reactMotion.Motion,
	          { style: style, key: i },
	...
	_reactDom2.default.render(_react2.default.createElement(Demo, null), document.querySelector('#demo1-container'));
